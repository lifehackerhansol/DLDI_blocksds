...
// M3 defines
// M3 MCCNT1 flags
#define M3DS_CTRL_BASE                (MCCNT1_ENABLE | MCCNT1_RESET_OFF | MCCNT1_CMD_SCRAMBLE | MCCNT1_CLOCK_SCRAMBLER | MCCNT1_READ_DATA_DESCRAMBLE)
#define M3DS_CTRL_GENERAL             (M3DS_CTRL_BASE | MCCNT1_LATENCY2(24) | MCCNT1_LEN_4 | MCCNT1_LATENCY1(0))
#define M3DS_CTRL_SD_READ             (M3DS_CTRL_BASE | MCCNT1_LATENCY2(24) | MCCNT1_LEN_512 | MCCNT1_LATENCY1(0))
#define M3DS_CTRL_SD_WRITE            (M3DS_CTRL_BASE | MCCNT1_DIR_WRITE | MCCNT1_LATENCY2(24) | MCCNT1_LEN_512 | MCCNT1_LATENCY1(256))
#define M3DS_CTRL_SD_MULTI_SECTOR_END (M3DS_CTRL_BASE | MCCNT1_LATENCY2(8) | MCCNT1_LEN_0 | MCCNT1_LATENCY1(256))
